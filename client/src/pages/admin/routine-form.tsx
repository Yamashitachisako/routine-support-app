  ...
  if (isEditMode && detailQuery.isError) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-4">
        <p className="text-destructive">{t.adminLoadError}</p>
        <Button variant="outline" onClick={() => setLocation("/admin/routines")}>
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 pb-12">
      ...
      <Card className="bg-white/60 border-none">
        <CardContent className="p-5 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 sm:col-span-2 flex items-center justify-between rounded-lg bg-white/40 p-3">
      ...
      <div className="space-y-3">
        ...
        {steps.map((step, idx) => (
          <Card key={idx} className="bg-white/60 border-none">
            <CardContent className="p-5 space-y-4">
              <div className="flex items-center justify-between">
      ...
      {/* アクション */}
      <div className="sticky bottom-0 bg-background/80 backdrop-blur-sm border-t border-border py-4 -mx-4 px-4 flex flex-wrap gap-3">
        <Button
          type="submit"
          disabled={isSaving}
